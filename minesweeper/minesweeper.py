...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        new_sentence_cells -= self.mines  # Remove known mines
        new_sentence_cells -= self.safes  # Remove known safes
        ...
        while True:
            ...
            for sentence in self.knowledge:
                ...
                if sentence.known_mines():
                    newly_mine.update(sentence.known_mines())
                    any_updated = True

            for safe_cell in newly_safe:
                self.mark_safe(safe_cell)
            for mine_cell in newly_mine:
